<template>
  ...
  <footer class="w-full h-fit py-6 flex justify-center items-center bg-agency-blue md:flex-row">
    <div class="flex w-5/12 flex-row justify-end lg:flex-row sm:flex-col sm:items-start sm:justify-evenly ">
      <a target="_blank" href="mailto:ventas.mxtravel2@gmail.com" class="flex mb-4 no-underline justify-center items-center h-fit lg:mb-0">
      ...
      <a target="_blank" href="https://www.instagram.com/mxtravelcuu?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="flex no-underline justify-center items-center h-fit">
    ...
    <div class="flex w-2/6 flex-row lg:flex-row sm:flex-col sm:items-start sm:justify-evenly ">
      <a target="_blank" href="https://www.facebook.com/agenciamxtravel" class="flex mb-4 lg:m-0 no-underline justify-center items-center h-fit">
      ...
      <a target="_blank" href="https://www.tiktok.com/@mxtravelcuu?is_from_webapp=1&sender_device=pc" class="flex no-underline justify-center items-center h-fit">
